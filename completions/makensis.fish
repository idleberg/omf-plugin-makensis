complete -c makensis -o CMDHELP -d 'Prints out help for all commands'
complete -c makensis -o INPUTCHARSET -a 'ACP OEM UTF8 UTF16LE UTF16BE' -d 'Prints information about what options makensis was compiled with'
complete -c makensis -o OUTPUTCHARSET -a 'ACP OEM UTF8 UTF8SIG UTF16LE UTF16BE UTF16LEBOM UTF16BEBOM>' -d 'Prints information about what options makensis was compiled with'
